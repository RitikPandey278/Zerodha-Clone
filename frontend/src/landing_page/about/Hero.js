...
function Hero() {
    return ( 
        <div className='container'>
            ...
            <div className='row p-5  border-top text-muted' style={{lineHeight:"1.8", fontSize:"1.1em"}}>
